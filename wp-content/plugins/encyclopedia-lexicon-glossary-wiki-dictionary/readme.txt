...
* **Tooltip**		- Add links and title description to predefined items that are contained in your site.
...
* **YouTube/Vimeo**	- Show YouTube / Vimeo videos in your entries.
...
* Send it via E-Mail to &lt; Translation [@t] [DennisHoppe](https://DennisHoppe.de/) [dot] de &gt;.
* Thats it. Thank you! =)
...
* [Upserve Glossary](https://upserve.com/glossary/)
...
The most features are available but you cannot select every option. You will find a small notice for each unavailable option on the settings page. The maximal number of encyclopedia items is limited to thirteen.
...
* PHP version 5.5.38 or greater; PHP 7 is recommended!
